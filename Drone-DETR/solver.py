...
class BaseSolver(object):
    ...
    def _setup(self, ):
        ...
        self.model = warp_model(self.model.to(device), sync_bn=cfg.sync_bn, \
    ...
    def train(self, ):
        ...
        self.train_dataloader = warp_loader(self.cfg.train_dataloader, \
            shuffle=self.cfg.train_dataloader.shuffle)
        self.val_dataloader = warp_loader(self.cfg.val_dataloader, \
